...
public class CSLLTest {
    public static void main (String[] args) {
        ...
        CSLL csll1 = new CSLL(new SNode(4));
        ...
        System.out.println("Value of head node of csll1: 4"); 
        System.out.println("Value of tail node of csll1: 4"); 
        System.out.println();

        // actual result 
        System.out.println("Actual Result: ");
        System.out.println("Size of csll1: " + csll1.getSize()); 
        System.out.println("Value of head node of csll1: " + csll1.getHead().getData());
        System.out.println("Value of tail node of csll1: " + csll1.getTail().getData());
        System.out.println();
        ...
        // expected result
        System.out.println("Expected Result: ");
        System.out.println("Size of csll2: 0"); 
        ...
        // actual result
        System.out.println("Actual Result: ");
        System.out.println("Size of csll2: " + csll2.getSize()); 
        ...
        csll2.insertHead(new SNode(7));
        System.out.println("insertHead(SNode node) method successfully inserted 7 to the head of \"csll2\".");

        // test inherited and modified insertHead(SNode node) method from SLL class
        csll2.insertHead(new SNode(1));
        System.out.println("insertHead(SNode node) method successfully inserted 1 to the head of \"csll2\".");

        // test inherited and modified insertTail(SNode node) method from SLL class
        csll2.insertTail(new SNode(3));
        System.out.println("insertTail(SNode node) method successfully inserted 3 to the tail of \"csll2\".");
        // test inherited and modified insert(SNode node, int position) method from SLL class
        csll2.insert(new SNode(5), 2);
        System.out.println("insert(SNode node, int position) method successfully inserted 5 to position 2 of \"csll2\".");
        System.out.println();
        ...
        System.out.println("List Content: 1 7 5 3");
        System.out.println();
        ...
        System.out.println("List Content: 1 3 5 7");
        System.out.println();
        ...
        System.out.println("sortedInsert(SNode node) method successfully inserted a new SNode with \"data\" 2 in a sorted order.");
        System.out.println();
        ...
        System.out.println("Sorted Status: sorted");
        System.out.println("List Content: 1 2 3 5 7");
        System.out.println();
        ...
        SNode nodeToSearch2 = new SNode(8);
        System.out.println();
        System.out.println("Node(int data) method successfully created a Node object with data 8.");;
        ...
        System.out.println("List Length: 4");
        System.out.println("Sorted Status: sorted");
        System.out.println("List Content: 2 3 5 7");
        System.out.println();
        ...
        System.out.println("Sorted Status: sorted");
        System.out.println("List Content: 2 3 5");
        System.out.println();
        ...
        SNode nodeToDelete = csll2.getHead().getNext(); 
        csll2.delete(nodeToDelete);
        System.out.println();
        System.out.println("delete(SNode node) method successfully deleted 5 from \"csll2\".");
        System.out.println();
        ...
        System.out.println("Sorted Status: sorted");
        System.out.println("List Content: 2 5");
        System.out.println();
