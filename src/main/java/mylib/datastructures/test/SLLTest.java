...
public class SLLTest {
    ...
    System.out.println();
    System.out.println("Node(int data) method successfully created a Node object with data 2.");;
    ...
    System.out.println("insertHead(Node node) method successfully inserted 5 to the head of \"sll2\".");

    // test insertHead(SNode node)
    sll2.insertHead(new SNode(2));
    System.out.println("insertHead(Node node) method successfully inserted 2 to the head of \"sll2\".");

    // test insertTail(SNode node)
    sll2.insertTail(new SNode(8));
    System.out.println("insertTail(Node node) method successfully inserted 8 to the tail of \"sll2\".");

    // test insert(SNode node, int position)
    sll2.insert(new SNode(3), 2);
    System.out.println("insertHead(Node node) method successfully inserted 3 to position 2 of \"sll2\".");
    System.out.println();
    ...
    System.out.println();
    System.out.println("Testing search(Node node) method by using previously created SLL object \"sll2\"...");
    System.out.println();

    SNode nodeToSearch1 = new SNode(5);
    System.out.println("Node(int data) method successfully created a Node object with data 5.");;
