...
public class DLLTest {
    ...
    System.out.println("Overloaded constructor DLL(SNode head) created a new DLL object \"dll1\".");
    System.out.println();
    ...
    System.out.println("insertHead(DNode node) method successfully inserted 3 to position 2 of \"dll2\".");
    System.out.println();
    ...
    System.out.println();
    System.out.println("Testing search(Node node) method by using previously created SLL object \"dll2\"...");
    System.out.println();
    ...
    // test clear()
    dll2.clear();
    System.out.println("clear() method successfully removed all nodes in the previously created SLL object \"dll2\".");
